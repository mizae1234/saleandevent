    ...
    if (data.length === 0) {
        return (
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-4">🏪 ผลงาน Event</h3>
                <div className="py-12 text-center text-slate-400">ไม่มีข้อมูล Event ในช่วงนี้</div>
            </div>
        );
    }
    ...
    return (
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            <div className="p-6 pb-3">
                <h3 className="text-lg font-bold text-slate-900">🏪 ผลงาน Event</h3>
            </div>

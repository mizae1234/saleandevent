        ...
        contents: [
          ...
          },
          {
            ...
            contents: [
              ...
              menuButton('2. สรุปภาพรวม', 'ดูสรุปภาพรวมยอดขายหลัก', 'สรุปภาพรวม'),
              menuButton('3. รายงานดำเนินงาน', 'ดูความคืบหน้างานขนส่งเบิกจ่าย', 'รายงานการดำเนินงาน'),
              menuButton('4. สรุปสต็อกคลัง', 'ดูภาพรวมสินค้าคงเหลือ', 'สรุปสต็อกคลัง'),
              menuButton('5. งานอีเว้นท์ที่เปิดอยู่', 'ดูงานที่ active อยู่', 'งานอีเว้นท์ที่เปิดอยู่'),
            ],
          },
        ],
        paddingAll: 'lg',

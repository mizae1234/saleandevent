...
export default async function WarehousePackingPage() {
    const events = await getPackingEvents();
    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-slate-500">รายการ Event ที่รอการจัดเตรียมสินค้าจากคลัง</p>
            </div>
            ...
            <section>
                <h2 className="text-lg font-semibold text-slate-800 mb-4 flex items-center gap-2">
                    ...
                    รอแพค ({packingEvents.length})
                </h2>

                {packingEvents.length === 0 ? (
                    <div className="rounded-xl bg-white p-12 text-center shadow-sm">
                        <Package className="h-12 w-12 text-slate-300 mx-auto mb-3" />
                        <p className="text-slate-500">ไม่มีรายการรอแพค</p>
                    </div>
                ) : (

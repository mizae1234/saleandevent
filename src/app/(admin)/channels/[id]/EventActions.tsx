                ...
                <div>
                    {!showTopUp ? (
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-teal-600 text-white rounded-lg hover:bg-teal-700 text-sm font-medium transition-colors"
                        >
                        ...
                        <div className="bg-teal-50 border border-teal-200 rounded-lg p-3 space-y-3">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-1 px-3 py-2 bg-teal-600 text-white rounded-lg text-sm disabled:opacity-50 transition-colors"
                                >
